...
urls = []
with open('unscraped_urls.csv', 'r' ) as csv_file:
...
def scrape(i):
    ...
    try:
        ...
        with open(f'outputs/0_{str(i)}_output.csv', 'w', newline='', encoding="utf-8", errors="ignore") as new_file:
...
with concurrent.futures.ThreadPoolExecutor(max_workers=32) as executor:
    results = [executor.submit(scrape, i) for i in range(0,len(urls))]
